	    ...
	    <div class="row">
	    	...
	    	<div class="col-md-3 left-column">
	    		...
	    		<div class="chatter_sidebar">
					...
					<a href="/<?php echo e(Config::get('chatter.routes.home')); ?>"><i class="chatter-bubble"></i> All <?php echo e(Config::get('chatter.titles.discussion')); ?></a>
				        	...
				        	<li>
				        		<a class="discussion_list" href="/<?php echo e(Config::get('chatter.routes.home')); ?>/<?php echo e(Config::get('chatter.routes.discussion')); ?>/<?php echo e($discussion->category->slug); ?>/<?php echo e($discussion->slug); ?>">
					        		...
					        		<div class="chatter_middle">
					        			...
					        			<p><?php echo e(substr(strip_tags($discussion->post[0]->body), 0, 200)); ?><?php if(strlen(strip_tags($discussion->post[0]->body)) > 200): ?><?php echo e('...'); ?><?php endif; ?></p>
					        		</div>
...
<?php echo $__env->make(Config::get('chatter.master_file_extend'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/my_project 3/vendor/devdojo/chatter/src/Views/home.blade.php ENDPATH**/ ?>